...
static unsigned char XPN_HWINFO_RESPONSE[]        = { 0x0C, 0x00, 0x1A, 0x00, 0x01, 0x02, 0x00, 0x00, 0x48, 0x01, 0x00, 0x00 };
...
static unsigned char XPN_X_Z21_FIRMWARE_VERSION[] = { 0x09, 0x00, 0x40, 0x00, 0xF3, 0x0A, 0x01, 0x48, 0xCA };
...
int send_xpn_system_info(char *vchar) {
	...
	xpnframe[4] = 200; /* MainCurrent */
    xpnframe[6] = 10; /* ProgCurrent */
    xpnframe[8] = 150; /* FilteredMainCurrent */
    xpnframe[10] = 20; /* Temperature */
    xpnframe[12] = 0x50; /* SupplyVoltage */
	xpnframe[13] = 0x46; /* SupplyVoltage */
    xpnframe[14] = 0x50; /* VCCVoltage */
	xpnframe[15] = 0x46; /* VCCVoltage */
    xpnframe[16] = 0x00; /* CentralState */
    xpnframe[17] = 0x00; /* CentralStateEx */
	xpnframe[18] = 0x00; /* reserved */
	xpnframe[19] = 0x77; /* Capabilities */
